...
// default.
// WithDNSResolver 提供 自定义的 DNS 解析 替代系统默认dns解析
...
// WithDatastore 提供 数据存储 替代 内存映射数据存储
// 数据存储 用于 已发布的 IPNS 记录：确保他们的查询可用
// IPNS 类似 http 协议下的 DNS
...
// NewNameSystem 将基于 路由 构建 ipfs 命名系统
